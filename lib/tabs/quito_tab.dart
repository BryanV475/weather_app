...
class QuitoTab extends StatefulWidget {
  const QuitoTab({Key? key}) : super(key: key);

  @override
  _QuitoTabState createState() => _QuitoTabState();
}

class _QuitoTabState extends State<QuitoTab> {
  ...
  Future<void> getData() async {
    data = await apiClient.getCurrentWeather("-0.22985", "-78.52495");
