...
import '../database/city.dart';
import '../database/db.dart';

class LatacungaTab extends StatefulWidget {
  const LatacungaTab({Key? key}) : super(key: key);

  @override
  _LatacungaTabState createState() => _LatacungaTabState();
}

class _LatacungaTabState extends State<LatacungaTab> {
  ...
  Future<void> getData() async {
    data = await apiClient.getCurrentWeather("-0.93521", "-78.61554");
